...
(function($) {
    ...
    * ------------------------------------------------------ */
    ...
    var setColor = function() {
        let colors = ['#03a9f4', '#EE7B2D', '#9771A6', '#2D7436', '#af0f25'];
        ...
        if(randomColor == 0){
           ...
           bgSrc =  "images/bg1.jpg";
            ...
            bgSrc =  "images/bg3.jpg";
            } 
        else if (randomColor == 3){
            src = "images/logo4.png"
            bgSrc =  "images/bg4.jpg";
            } 
        else if (randomColor == 4){
            src = "images/logo5.png"
            bgSrc =  "images/bg5.jpg";
            } 

        logo.src = src;
        bg.setAttribute('data-image-src',bgSrc)
        document.documentElement.style.setProperty('--color', colors[randomColor]);
    };
